    ...
    def train(self, epochs=20000, log_every=1000,
        ...
        for epoch in pbar:
            ...
            if self.is_american:
                ...
                payoff_a = self._payoff(S_a)
                # penalise V < payoff (violation of early-exercise constraint)
                loss_american = torch.mean(
                    torch.clamp(payoff_a - V_pred, min=0.0) ** 2
                )
